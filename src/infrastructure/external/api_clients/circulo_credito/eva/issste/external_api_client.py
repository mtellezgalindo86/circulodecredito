...
class ExternalIsssteClient:

    def __init__(self):
        self.base_url = BASE_URL

    def evPrivacyNotice(self, data):
        try:
            url = f"{BASE_URL}/v2/eva/employmentverifications/withPrivacyNotice"
            data = data.dict()
    ...
    def getInfoEmployment(self, employmentId):
        try:
            url = f"{BASE_URL}/v2/eva/employmentverifications/{employmentId}"
