import base64
import json
from src.application.services.eva.issste.get_eva_inquiry_id_service import getEvaInquiryIdService
from src.domain.repositories.bureau_logs_repository import BureauLogsRepository


class GetEvaInquiryIsssteIdUseCase:
    ...
    def execute(self, data):
        try:
            ...
            print("se obtiene la respuesta de getEvaInquiryId", response)
